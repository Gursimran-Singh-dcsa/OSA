  ...
  if (!isError) {
    return (
      <Row className={`${styles.kpi_wrapper}`} gutter={[16, 16]}>
        ...
        >
          <Row style={{ height: "6rem", paddingTop: "1rem" }} justify="center">
            <Image src={salesRepIcon} />
          </Row>
          <Row justify="center" style={{ height: "6rem", paddingTop: "2rem" }}>
        ...
        <Col xs={24} md={24} lg={13} xl={13}>
          ...
          <Row gutter={[8, 16]}>
            ...
            <Col xs={24} md={12} lg={14} style={{ padding: "0px !important" }}>
              <Row
                gutter={[{ xs: 64, sm: 64, md: 64, lg: 16, xl: 16 }, 16]}
                justify="center"
              >
