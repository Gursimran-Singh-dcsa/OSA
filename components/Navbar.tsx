...
const navigationRoutes = [{name:'OSA OVERVIEW',component:"home"}, {name:'LOGBOOK',component:"logBook"}, {name:'ANALYTICS', component:"analytics"}, {name:'SCORECARD',component:"scoreCard"}];
