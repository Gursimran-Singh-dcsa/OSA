...
//   coreSKUsEAN: "77989343243282"
// coreSkUsDescription: "Axe AER B SPRAY TEMPT 12x96g/150ml"
// status: "available"
  ...
  const GetOverlay = ({ type }: any) => {
    ...
    return (
      <Menu
        className={`${styles.menu_component} ${
          "assignedTo" === type ? styles[`${type}_menu_component`] : ""
        }`}
        onOpenChange={(data) => {
          if (data.length) {
  ...
  return (
    ...
    >
      ...
      <Row>
        <Col>
        <Row style={{ backgroundColor: "#1E1E1E", maxHeight: '100px' }}>
        <div className={styles.tableScroll}><TableComponent
